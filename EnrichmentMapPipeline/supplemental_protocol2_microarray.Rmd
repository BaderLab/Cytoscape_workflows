...
expressionMatrix <- as.matrix(read.table(
  paste(working_dir, "Supplementary_Table9_TCGA_Microarray_rmanormalized.txt",sep="/"), header = TRUE, sep = "\t", quote="\"", stringsAsFactors = FALSE))
...
```{r}
classDefinitions <- read.table( paste(working_dir,"Supplementary_Table10_Microarray_classdefinitions.txt",sep="/"), header = TRUE, sep = "\t", quote="\"", stringsAsFactors = FALSE)
