...
fileConn <- file(
  file.path(working_dir,"Supplementary_Table9_TCGA_OV_RNAseq_classes.cls"))
...
```{r  echo=FALSE, fig.cap="Heatmap of all genes and all patient samples.  Different patient cancer types are marked on the x-axis.  Genes are clustered according to expression and patients are ordered according to subtype."}
