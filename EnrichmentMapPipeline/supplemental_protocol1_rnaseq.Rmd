...
#alternately you can also use the glm model using contrasts.  For a simple 2 class comparison this is not required but if you want to compare
...
ann_colors = list(SUBTYPE = c(Immunoreactive="blue", Mesenchymal="red",Proliferative = "orange",Differentiated="darkgreen"))
